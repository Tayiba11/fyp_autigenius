...
class _FirstScreenState extends State<suspiciousScreen> {
        ...
        child: Container(
          ...
          child: Center(
            child: AnimatedContainer(
              ...
              width: imageSize,
              height: imageSize,
              child: Image.asset('assets/images/expressions/Suspicious.png'), // Replace with your image
            ),
          ),
        ),
      ),
