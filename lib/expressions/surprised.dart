...
class _FirstScreenState extends State<surprisedScreen> {
        ...
        child: Container(
          ...
          child: Center(
            child: AnimatedContainer(
              ...
              width: imageSize,
              height: imageSize,
              child: Image.asset('assets/images/expressions/Surprised.png'), // Replace with your image
            ),
          ),
        ),
      ),
