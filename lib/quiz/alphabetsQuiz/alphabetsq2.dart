          ...
          children: [
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AlphabetWrong2Screen()));
                  },
                  child: Container(
                    width: 140,
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AlphabetCorrect2Screen()));
                  },
                  child: Container(
                    width: 140,
                    child: CardBoxWithImage(
